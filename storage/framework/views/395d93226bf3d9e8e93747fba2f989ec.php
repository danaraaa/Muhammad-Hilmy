...
<body>
    ...
    <div class="main-content">
        ...
        <header style="display: flex; justify-content:space-between">
            ...
            <div>
                <button class="card-button"> Add Button </button>
            </div>
        </header>
        ...
        <div>
            <div class="container">
                ...
                <form action="<?php echo e(url('/produk/edit/' . $ubahProduk->kode_produk)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\ASUS\Herd\project_laravel\resources\views/editproduk.blade.php ENDPATH**/ ?>